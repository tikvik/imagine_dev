...
function qtranxf_generateLanguageSelectCode( $args = array(), $id = '' ) {
	...
	echo PHP_EOL . '<ul class="language-chooser language-chooser-' . $type . ' qtranxs_language_chooser navbar-nav" id="' . $id . '">' . PHP_EOL;
	switch ( $type ) {
		case 'image':
		case 'text':
		case 'css_only':
		case 'dropdown':
			{
				foreach ( qtranxf_getSortedLanguages() as $language ) {
					...
					echo '<li class="' . implode( ' ', $classes ) . ' nav-item "><a href="' . qtranxf_convertURL( $url, $language, false, true ) . '"';
					// set hreflang
                    ...
                    elseif ( $type == 'text' ) {
						echo ' class="nav-link qtranxs_text qtranxs_text_' . $language . '"';
